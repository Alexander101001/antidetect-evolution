"""
🤗 Depth estimation for images
Uses: lpiccinelli/unidepth-v2-vitl14
"""
import json
import requests
...
class UnidepthV2Vitl14:
    """Wrapper for lpiccinelli/unidepth-v2-vitl14"""
...
if __name__ == "__main__":
    ...
    print(f"   Use: Depth estimation for images")
    print(f"   Importance: LOW")
