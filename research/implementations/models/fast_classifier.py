"""
🤗 Faster classification than BERT
Uses: google/electra-base-discriminator
"""
import json
import requests
...
class ElectraBaseDiscriminator:
    """Wrapper for google/electra-base-discriminator"""
...
if __name__ == "__main__":
    ...
    print(f"   Use: Faster classification than BERT")
